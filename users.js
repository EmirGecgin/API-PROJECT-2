...
function displayInformationInCards(userData) {
    ...
    userData.forEach(userInfo => {
        userInfoCard.innerHTML +=
            ...
            <div class=" card w-100 m-3 rounded-3">
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="user-info-details">
                        ...
                        <a href="posts.html?userId=${userInfo.id}" class="btn btn-outline-dark">Show details</a>
                    </div>
                    <div class="justify-content-center d-flex">
                        <div class="showButton text-center d-flex justify-content-center mt-3">
